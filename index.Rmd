...
```{r removals sunburst, warning=FALSE, fig.align = "center", out.width = '95%', fig.cap="Sunburst diagram demonstrating proportional breakdown of greenhouse gas removals in the UK (Land Use, Land Use Change, and Forestry Sector) in 2022."}
...
act_neg <- GHG_UK2022neg %>%
  group_by(tes_subsector, tes_category, activity) %>%
  summarize(Temissions = sum(emissions_mt_co2e, na.rm = TRUE)) %>%
...
GHGsb2_neg <- data.frame(
  parents =c(paste0(cat_neg$tes_subsector), paste0(act_neg$parents)),
  labels =c(paste0(cat_neg$tes_category), paste0(act_neg$activity)),
  values =as.numeric(c(paste0(cat_neg$Temissions), paste0(act_neg$Temissions)))
)
...
#Bar plot by category, colored by subsector with Plotly
...
```{r, warning=FALSE, fig.align = "center", out.width = '65%', fig.cap="Bar graph showing greenhouse gas emissions in megatonnes of CO2 equivalents in the agricultural combustion subsector in 2022 by category, stacked by fuel type."}
...
```{r, warning=FALSE, fig.align = "center", out.width = '95%', fig.cap="Bar graph showing greenhouse gas emissions in megatonnes of CO2 equivalents in the agricultural soils subsector in 2022 by category, stacked by greenhouse gas identity."}
...
```{r, warning=FALSE, fig.align = "center", out.width = '95%', fig.cap="Bar graph showing greenhouse gas emissions in megatonnes of CO2 equivalents in the livestock subsector in 2022 by category, stacked by greenhouse gas identity."}
...
```{r, warning=FALSE, fig.align = "center", out.width = '95%', fig.cap="Bar graph showing greenhouse gas emissions in megatonnes of CO2 equivalents in the livestock subsector in 2022 by category, stacked by animal kind."}
...
agls2_int <- GHG_UK2022 %>% 
  ...
  add_trace(y = ~sheep, name = 'Sheep', marker = list(color ="#F0C954")) %>%
...
```{r, warning=FALSE, fig.align = "center", out.width = '95%', fig.cap="Bar graph showing greenhouse gas emissions in megatonnes of CO2 equivalents in the livestock subsector in 2022 by animal, stacked by greenhouse gas identity."}
...
```{r, warning=FALSE, fig.align = "center", out.width = '65%', fig.cap="Bar graph showing greenhouse gas emissions in megatonnes of CO2 equivalents in the agricultural 'other' subsector in 2022 by category, stacked by greenhouse gas identity."}
...
```{r, warning=FALSE, fig.align = "center", out.width = '95%', fig.cap="Bar graph showing greenhouse gas emissions in megatonnes of CO2 equivalents in the UK's LULUCF sector in 2022 by subsector, colored by greenhouse gas identity."}
...
```{r, warning=FALSE, fig.align = "center", out.width = '95%', fig.cap="Bar graph showing greenhouse gas emissions in megatonnes of CO2 equivalents in the UK's LULUCF sector in 2022 by source, colored by greenhouse gas identity."}
...
```{r, message=FALSE, warning=FALSE, fig.align = "center", out.width = '95%', fig.cap="Bar graph showing greenhouse gas emissions in megatonnes of CO2 equivalents in the UK's LULUCF sector in 2022 by source, colored by subsector and grouped by greenhouse gas identity."}
...
```{r, warning=FALSE, fig.align = "center", out.width = '95%', fig.cap="Bar graph showing greenhouse gas emissions in megatonnes of CO2 equivalents in the bioenergy crops subsector in 2022 by source, colored by greenhouse gas identity."}
...
```{r, warning=FALSE, fig.align = "center", out.width = '95%', fig.cap="Bar graph showing greenhouse gas emissions in megatonnes of CO2 equivalents in the cropland mineral soils change subsector in 2022 by source, colored by greenhouse gas identity."}
...
```{r, warning=FALSE, fig.align = "center", out.width = '95%', fig.cap="Bar graph showing greenhouse gas emissions in megatonnes of CO2 equivalents in the grassland mineral soils change subsector in 2022 by source, colored by greenhouse gas identity."}
...
```{r, warning=FALSE, fig.align = "center", out.width = '95%', fig.cap="Bar graph showing greenhouse gas emissions in megatonnes of CO2 equivalents in the forestry subsector in 2022 by source, colored by greenhouse gas identity."}
...
```{r, warning=FALSE, fig.align = "center", out.width = '95%', fig.cap="Bar graph showing greenhouse gas emissions in megatonnes of CO2 equivalents in the peatland subsector in 2022 by source, colored by greenhouse gas identity."}
...
```{r, warning=FALSE, fig.align = "center", out.width = '65%', fig.cap="Bar graph showing greenhouse gas emissions in megatonnes of CO2 equivalents in the 'other' LULUCF subsector in 2022 by source, colored by greenhouse gas identity."}
...
```{r, warning=FALSE, fig.align = "center", out.width = '95%', fig.cap="Bar graph showing greenhouse gas emissions in megatonnes of CO2 equivalents in the UK's waste sector in 2022 by subsector, colored by greenhouse gas identity."}
